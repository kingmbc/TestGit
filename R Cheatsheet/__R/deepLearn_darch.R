...
# Prepare the layers for backpropagation training 
# the layer functions must be set to the unit functions 
# which calculates the also derivatives of the function result.
